...
words <- c("these", "are", "random", "words", "I", "created")
...
WordBin <- function(words, first.letter, second.letter) {
  return(words[tolower(words) >= first.letter & tolower(words) <= second.letter])
}
